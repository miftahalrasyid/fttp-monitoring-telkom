...
import { checkLogin, verifyOtp,forgotPageClosed} from "../store/auth/actions"
...
function Login(props) {
  ...
  // }
  console.log("error status",error,isUserVerifyLoading)
  return (
    <Grid container className={styles.container}>
      ...
      <div className={styles.formContainer}>
        ...
        © 2014-{new Date().getFullYear()} <a style={{ textDecoration: 'none', color: 'inherit' }} href="https://telkom.com" rel="noopener noreferrer" target="_blank">Telkom Indonesia</a>, Tbk. All rights reserved.
        </Typography>
      </div>
    </Grid>
  );
